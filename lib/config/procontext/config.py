...
"""
Add default config for ProContEXT.
"""
cfg = edict()
...
cfg.MODEL.NUM_OBJECT_QUERIES = 1   # 几个目标
# TRAIN
cfg.TRAIN = edict()
cfg.TRAIN.LR = 0.0001
...
cfg.TEST.EPOCH = 500
cfg.TEST.USE_VISDOM = 1
cfg.TEST.SAVE_ALL_BOXES = 0
cfg.TEST.USE_CMC = False
