...
def get_optimizer_scheduler(net, cfg):
    ...
    if cfg.TRAIN.FINETUNE:
        ...
        param_dicts = [  # 添加未冻结的层 # 假设新添加的CMCBlock和其他需要训练的层的参数名称中包含 'cross_modal_block' 或其他特定标识
            {"params": [p for n, p in net.named_parameters() if 'cross_modal_block' in n and p.requires_grad]}
        ]
        if is_main_process():
            print("Fine-tuning. Learnable parameters are shown below.")
    ...
    if cfg.TRAIN.SCHEDULER.TYPE == 'step':   # 是这个
