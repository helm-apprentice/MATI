...
def main():
    ...
    parser.add_argument('--script', default='procontext', type=str, required=True, help='Name of the train script.')
    parser.add_argument('--config', default='vitb_384_mae_ce_32x4_got10k_ep300', type=str, required=True, help="Name of the config file.")
